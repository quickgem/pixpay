...
function PRINT_TICKET(trans,cb,rePrint,currIndex,arg) {
    ...
    addTextSpace(`${Tos.GLOBAL_CONFIG.studentInfo.FirstName + ' ' + Tos.GLOBAL_CONFIG.studentInfo.MiddleName + ' ' + Tos.GLOBAL_CONFIG.studentInfo.Surname}`,ALIGN_CENTER,fontSize.MIDDLE);
    addTextSpace(Tos.GLOBAL_CONFIG.studentInfo.SchoolName,ALIGN_CENTER,fontSize.MIDDLE);
    addTextSpace( '-----------------------------------------------------',ALIGN_LEFT,fontSize.MIDDLE);
    // if(currIndex === 1) {
