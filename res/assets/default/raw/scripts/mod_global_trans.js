...
function GLOBAL_PREENTRY(){
    ...
    this.getEntryList =function (){
        this.entryList = [
            {
                appName: "GetStarted", icon: "",
                transParam:{appName:"Get Started",transType: TRANS_TYPE.SALE, msgType:"0200",procCode:"000000",serviceCode:"00",needSave:true,nReversal:true},
                entry: ["payment", "profile", "makeTransfer", "searchCard",[["emvProcess","result"],["emvProcess","result"],["emvProcess","result"]]], // checking if this is the entry flow
            },
            // FILE INDEX 1
        ];
